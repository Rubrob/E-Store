...
import { filterProductsWithURL, fetchProducts } from 'redux/actions/products';
    ...
    const routes = [
        {
            exact: true,
            path: '/',
            component: createLoadableComponent(() =>
...
export default compose(
    ...
    connect(
        ...
        (dispatch) => ({
            filterProductsWithURL: (value) =>
                dispatch(filterProductsWithURL(value)),
